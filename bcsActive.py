...
class BCS_Cordination_Email_Generator:
    def __init__(self, top=None):
        ...
        self.customer.configure(textvariable=bcsActive_support.customer)
        ...
        self.pLine.configure(textvariable=bcsActive_support.pLine)
        ...
        self.pType.configure(textvariable=bcsActive_support.pType)
        ...
        self.product.configure(textvariable=bcsActive_support.product)
        ...
        self.subject.configure(textvariable=bcsActive_support.subject)
        ...
        self.mDate.configure(textvariable=bcsActive_support.mDate)
        ...
        self.bcsDueDate.configure(textvariable=bcsActive_support.bcsDueDate)
        ...
        self.ftdDueDate.configure(textvariable=bcsActive_support.ftdDueDate)
        ...
        self.ftdLead.configure(textvariable=bcsActive_support.ftdLead)
        ...
        self.aTeam.configure(textvariable=bcsActive_support.aTeam)
        ...
        self.attachement = ttk.Combobox(self.TFrame2)
        self.attachement.place(relx=0.71, rely=0.04, relheight=0.09
                , relwidth=0.28)
        self.attachement.configure(textvariable=bcsActive_support.attachement)
        self.attachement.configure(takefocus="")
        ...
        self.stdPhrase.configure(textvariable=bcsActive_support.combobox)
        ...
        self.createEmail = ttk.Button(top)
        self.createEmail.place(relx=0.45, rely=0.93, height=30, width=128)
        self.createEmail.configure(takefocus="")
        self.createEmail.configure(text='''Create Email''')
        self.createEmail.bind('<Button-1>',lambda e:bcsActive_support.createEmail_1click(e))

        self.exit = ttk.Button(top)
        self.exit.place(relx=0.92, rely=0.93, height=30, width=78)
        self.exit.configure(takefocus="")
        self.exit.configure(text='''Exit''')
        self.exit.bind('<Button-1>',lambda e:bcsActive_support.exit_lclick(e))
        ...
        self.TFrame4.place(relx=0.01, rely=0.92, relheight=0.07, relwidth=0.28)
        ...
        self.save.bind('<Button-1>',lambda e:bcsActive_support.save_1click(e))
        ...
        self.search.bind('<Button-1>',lambda e:bcsActive_support.search_1click(e))
